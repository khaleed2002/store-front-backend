...
describe('Test methods results in UserModel', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        it('create method should add a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user.create(Khaled)];
                    case 1:
                        result = _a.sent();
        ...
        it('update method should update a user', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, user.update(Khaled)];
                    case 1:
                        result = _a.sent();
                        expect(result).toEqual({
                            id: 1,
        ...
        it('authenticate user', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user.authenticate('Khaled123', 'khaled101010')];
                    case 1:
                        jwt = _a.sent();
