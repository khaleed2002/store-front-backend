...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, products.show(parseInt(req.params.id))];
            case 1:
                product = _a.sent();
                res.json(product);
                return [2 /*return*/];
...
var getByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allProductsByCat, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, products.getProductsByCategory(req.body.category)];
            case 1:
                allProductsByCat = _a.sent();
...
var productRoute = function (app) {
    ...
    app.delete('/products', user_1.verifyAuthToken, destroy);
};
exports.categoryRoute = express_1.default.Router();
exports.categoryRoute.route('/category').get(getByCategory);
